...
//!
//! This crate focuses on enabling clear, declarative logic over iterables. It favors minimal,
//! well-scoped functions that can be easily composed with custom predicates or reused
//! across testing, validation, and filtering tasks.
//!
//! ## Example
//! ```
